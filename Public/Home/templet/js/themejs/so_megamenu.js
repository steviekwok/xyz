...
$(document).ready(function() {
	...
	$(".vertical .megamenu .loadmore").click(function(){
			if($(this).hasClass('open')){
				...
				$('.vertical .megamenu .loadmore').html('<i class="fa fa-plus-square-o"></i><span class="more-view">更多品类</span>');
			}else{
				...
				$(this).addClass('open');
				$('.vertical .megamenu .loadmore').html('<i class="fa fa-minus-square-o"></i><span class="more-view">关闭</span>');
			}
		});
